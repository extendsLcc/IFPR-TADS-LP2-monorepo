...
public class BorderLayoutMain {
    ...
    public static void main(String[] args) {
        ...
        janela.add( btn01 , BorderLayout.NORTH );
        janela.add( btn02 , BorderLayout.SOUTH );
        janela.add( btn03 , BorderLayout.CENTER );
        janela.add( btn04 , BorderLayout.EAST );
        janela.add( btn05 , BorderLayout.WEST );
